...
_G.packer_plugins = {
  ...
  ["one_monokai.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/one_monokai.nvim",
  ...
  snow = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/snow",
  ...
  vim = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim",
  ...
  ["whitespace.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/whitespace.nvim",
